export default function WAVE() {
 return (
  ...
  <img src='/multizzet_quote_bg.png' className='fade-in'/>
   ...
   a strong swimmer won't last ten wet minutes.</p></div>
   <div className='credit text-focus-in'>M. Bartley Seigel,<br/>"WAVE AFTER WAVE"</div>
 </div>
 )
}